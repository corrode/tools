...
static RUSTNATION_2024_BASE_URL: LazyLock<Url> =
    LazyLock::new(|| static_url("http://web.archive.org/web/20240329154221/https://www.rustnationuk.com/"));
...
mod tests {
    ...
    fn test_rustnation_2024_metadata() {
        ...
        assert_eq!(
            metadata.url,
            Url::parse("http://web.archive.org/web/20240329154221/https://www.rustnationuk.com/").expect("valid RustNation 2024 base URL")
        );
    }
}
