...
use types::Talk;
use types::Url;
use types::monitoring::{DayBucket, HourBucket, QueryStats, SearchQueryRow, TopQuery};
...
impl Repository {
    ...
    pub async fn get_query_stats(&self) -> Result<QueryStats> {
        ...
        let error_count_last_hour = self.get_error_count(1).await?;
    ...
    pub async fn get_hourly_histogram(&self, hours: i64) -> Result<Vec<HourBucket>> {
        let rows = sqlx::query(
    ...
    pub async fn get_daily_histogram(&self, days: i64) -> Result<Vec<DayBucket>> {
        let rows = sqlx::query(
    ...
    pub async fn get_zero_result_queries(&self, limit: i64) -> Result<Vec<TopQuery>> {
        let rows = sqlx::query(
    ...
    pub async fn get_error_count(&self, since_hours: i64) -> Result<i64> {
